<%@ Page Title="Manage Plans" Language="C#" MasterPageFile="~/flicboxAdmin/flicboxAdmin.Master" AutoEventWireup="true" CodeBehind="manage-plans.aspx.cs" Inherits="flicboxPWC_CMS.flicboxAdmin.manage_plans" %>
            ...
            <div class="col-md-12">
                <asp:GridView ID="grdvwProductMaster" runat="server" AutoGenerateColumns="False" EmptyDataText="There is No Data to display !"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SubscriptionName" HeaderText="Subscription Type" ItemStyle-Wrap="true">
                            <ItemStyle Wrap="True" Width="250px"></ItemStyle>
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Details">
                            <ItemTemplate>
                                <a class="editlink" href="plans-master.aspx?mode=2&ProductID=<%#Eval("intProductID") %>">Edit</a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Details">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDelete" CssClass="editlink" Text="Delete" runat="server" CommandName="delete"
                                    CommandArgument='<%# Eval("intProductID") %>' OnClientClick="javascript:return confirm('are you sure you want to delete this?')" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:TemplateField>
                    </Columns>
